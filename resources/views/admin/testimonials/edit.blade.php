...
<div class="mb-6 flex items-center justify-between">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-800">Edit Testimoni</h2>
            <p class="text-sm text-gray-500">Ubah data testimoni dari {{ $testimonial->client_name }}.</p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" class="p-6 sm:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" id="project_name" name="project_name" value="{{ old('project_name', $testimonial->project_name) }}" placeholder="Contoh: Interior Rumah PIK"
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="message" name="message" rows="4" required
                          class="w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500 @error('message') border-red-500 @enderror">{{ old('message', $testimonial->message) }}</textarea>
        ...
        <div class="flex items-center justify-between pt-5 border-t border-gray-200">
            <div class="text-sm text-gray-500">
                Terakhir diubah: {{ $testimonial->updated_at->format('d M Y, H:i') }}
            </div>
